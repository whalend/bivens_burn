...
sjPlot::plot_model(treeht_lmer1, type = "int")
...
surv_glmer0cm <- lme4::glmer(
  survival ~ tree_ht_scl + heat_flux_scl + flame_ht_scl + (1|Plot/tree_id),
  family = "binomial", 
...
surv_glmer25cm <- lme4::glmer(survival ~ tree_ht_scl + heat_flux_scl + flame_ht_scl + (1|Plot/tree_id), family = "binomial", data = dat25cm)
...
AIC(surv_glmer0cm, surv_glmer25cm, surv_glmer50cm.std)
...
sjPlot::plot_model(surv_glmer50cm.std, type = "pred", terms = c("tree_ht_scl", "flame_ht_scl"), pred.type = "fe")
